...
function CreatePlaceCodeForm({ handleSubmit }: { handleSubmit: (event: React.FormEvent<HTMLFormElement>, dept: string) => void }) {
...
export default function AddPlacementCoordinator() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>, dept: string) => {
    ...
    try {
        ...
        const response = await fetch('https://empowered-dw0m.onrender.com/api/v1/admin/addPlacementCoodinator', {
          method: 'POST',
          headers: {
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        >
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <CreatePlaceCodeForm handleSubmit={handleSubmit} />
          </Container>
        </Box>
        <ToastContainer />
      </Box>
